...
export const useKoiOwnerSearch = (debounceTime = 500) => {
  return useSearch<KoiDetailModel>({
    apiUrl: `${DYNAMIC_API_URL}/kois/get-kois-owner-by-keyword`,
    requiresAuth: true,
    preload: true,
    defaultQuery: "",
    debounceTime,
...
export const useKoiOwnerSearchNotAuth = (
  ...
  return useSearch<KoiDetailModel>({
    apiUrl: `${DYNAMIC_API_URL}/kois/get-kois-owner-by-keyword-not-auth`,
    requiresAuth: false,
    preload: true,
    defaultQuery: "",
    debounceTime,
...
export const useAllKoiSearch = (debounceTime = 500) => {
  return useSearch<KoiDetailModel>({
    apiUrl: `${DYNAMIC_API_URL}/kois/get-all-kois-by-keyword`,
    requiresAuth: true,
    preload: false,
    debounceTime,
  });
...
export const useKoiUnverifiedSearch = (debounceTime = 500) => {
  return useSearch<KoiDetailModel>({
    apiUrl: `${DYNAMIC_API_URL}/kois/get-unverified-kois-by-keyword`,
    requiresAuth: true,
    preload: true,
    defaultQuery: "",
    debounceTime,
...
export const useKoiInAuctionSearch = (debounceTime = 500) => {
  return useSearch<KoiInAuctionDetailModel>({
    apiUrl: `${DYNAMIC_API_URL}/auctionkois/get-kois-by-keyword`,
    limit: 12,
    requiresAuth: false,
    preload: true,
    defaultQuery: "",
...
export const useAuctionUpComingSearch = (debounceTime = 500) => {
  return useSearch<AuctionModel>({
    apiUrl: `${DYNAMIC_API_URL}/auctions/get-auctions-upcoming`,
    requiresAuth: true,
    preload: true,
    defaultQuery: "",
    debounceTime,
...
export const useUserOrderSearch = (debounceTime = 500) => {
  return useSearch<OrderResponse>({
    apiUrl: `${DYNAMIC_API_URL}/orders/search-user-orders-by-keyword`,
    requiresAuth: true,
    preload: false,
    debounceTime,
  });
