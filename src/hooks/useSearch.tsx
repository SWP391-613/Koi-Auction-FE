...
export const useKoiOwnerSearch = (debounceTime = 500) => {
  return useSearch<KoiDetailModel>({
    apiUrl: `${API_URL_DEPLOYMENT}/kois/get-kois-owner-by-keyword`,
    requiresAuth: true,
    preload: true,
    defaultQuery: "",
    debounceTime,
...
export const useKoiOwnerSearchNotAuth = (
  ...
  return useSearch<KoiDetailModel>({
    apiUrl: `${API_URL_DEPLOYMENT}/kois/get-kois-owner-by-keyword-not-auth`,
    requiresAuth: false,
    preload: true,
    defaultQuery: "",
    debounceTime,
...
export const useAllKoiSearch = (debounceTime = 500) => {
  return useSearch<KoiDetailModel>({
    apiUrl: `${API_URL_DEPLOYMENT}/kois/get-all-kois-by-keyword`,
    requiresAuth: true,
    preload: false,
    debounceTime,
  });
...
export const useKoiUnverifiedSearch = (debounceTime = 500) => {
  return useSearch<KoiDetailModel>({
    apiUrl: `${API_URL_DEPLOYMENT}/kois/get-unverified-kois-by-keyword`,
    requiresAuth: true,
    preload: true,
    defaultQuery: "",
    debounceTime,
...
export const useKoiInAuctionSearch = (debounceTime = 500) => {
  return useSearch<KoiInAuctionDetailModel>({
    apiUrl: `${API_URL_DEPLOYMENT}/auctionkois/get-kois-by-keyword`,
    limit: 12,
    requiresAuth: false,
    preload: true,
    defaultQuery: "",
...
export const useAuctionSearch = (debounceTime = 500) => {
  return useSearch<AuctionModel>({
    apiUrl: `${API_URL_DEPLOYMENT}/auctions/get-auctions-by-keyword`,
    limit: 30,
    requiresAuth: false,
    preload: true,
    defaultQuery: "",
...
export const useUserOrderSearch = (debounceTime = 500) => {
  return useSearch<OrderResponse>({
    apiUrl: `${API_URL_DEPLOYMENT}/orders/search-user-orders-by-keyword`,
    requiresAuth: true,
    preload: false,
    debounceTime,
  });
