...
import './FancyButton.css'; // Đảm bảo bạn đã tạo file CSS này

interface FancyButtonProps {
  text: string; // Văn bản hiển thị ban đầu
  hoverText: string; // Văn bản hiển thị khi hover
  to: string; // Đường dẫn để navigate
  className?: string; // Các class tùy chỉnh
}

const FancyButton: React.FC<FancyButtonProps> = ({ text, hoverText, to, className = '' }) => {
